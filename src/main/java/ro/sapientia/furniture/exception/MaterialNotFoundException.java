...
@Slf4j
public class MaterialNotFoundException extends AppHttpException {
    public MaterialNotFoundException(final Class<?> clazz, final Map<String, String> filterValues) {
    ...
    public MaterialNotFoundException(final Class<?> clazz) {
