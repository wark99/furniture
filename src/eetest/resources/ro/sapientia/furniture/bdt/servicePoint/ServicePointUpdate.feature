Feature: Check if the update endpoint works
  ...
  Scenario: No element
    Given that we have the following regions:
      | name   |
      | Kuwuki |
    Then I should get "RECORD_NOT_FOUND" error for updating "3" "1" "Uganda2 Country" "Uganda2 County" "Uganda2 city" "82th" "702B" "123222"
  ...
  Scenario: Multiple element
    ...
    Then I should get no error for updating "2" "1" "Uganda2 Country" "Uganda2 County" "Uganda2 city" "82th" "702B" "123222"
